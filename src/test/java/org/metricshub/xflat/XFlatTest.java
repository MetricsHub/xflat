...
class XFlatTest extends XFlatTestUtils {
	...
	void testParseXml() throws Exception {
		...
		assertThrows(XFlatException.class, () -> XFlat.parseXml(xml, "Disks/Disk>", ROOT_TAG));
		assertThrows(
				XFlatException.class, () -> XFlat.parseXml(xml, "Disks/Disk>Volumes/Volume>name", ROOT_TAG));
		assertThrows(
				XFlatException.class, () -> XFlat.parseXml(xml, "Disks/Disk>name/Volumes/Volume>name", ROOT_TAG));
	...
	void testPartialRootPath() throws Exception {
		...
		assertEquals(
				asList(
						asList("HPB7B952B1BA-subnet_one", "subnet_one"),
						asList("bond-1", "bond-name")),
	...
	void testUCSEquipmentFan() throws Exception {
		...
		final List<List<String>> expected = asList(
				...
				asList("equipmentFan", "sys/chassis-1/fan-module-1-1/fan-1", "NWG15030613", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-1/fan-2", "NWG15030613", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-2/fan-1", "NWG150305AQ", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-2/fan-2", "NWG150305AQ", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-3/fan-1", "NWG15030653", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-3/fan-2", "NWG15030653", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-4/fan-1", "NWG1503055C", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-4/fan-2", "NWG1503055C", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-5/fan-1", "NWG150305CM", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-5/fan-2", "NWG150305CM", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-6/fan-1", "NWG150306ZR", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-6/fan-2", "NWG150306ZR", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-7/fan-1", "NWG150305QP", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-7/fan-2", "NWG150305QP", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-8/fan-1", "NWG150306VZ", "N20-FAN5", "Cisco Systems Inc", "operable"),
				asList("equipmentFan", "sys/chassis-1/fan-module-1-8/fan-2", "NWG150306VZ", "N20-FAN5", "Cisco Systems Inc", "operable"));
